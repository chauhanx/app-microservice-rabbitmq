...
typeorm_1.createConnection().then(function (db) {
    amqp.connect(process.env.AMPQ_URL, function (err, conn) {
        ...
        conn.createChannel(function (error, channel) {
            ...
            var productData = db.getRepository(product_1.Product);
            ...
            app.post('/api/products', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productData.create(req.body)];
                        case 1:
                            product = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, productData.findOne(req.params.id)];
                        case 1:
                            product = _a.sent();
            ...
            app.delete('/api/products/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, productData.delete(req.params.id)];
                        case 1:
                            result = _a.sent();
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            product = _a.sent();
                            product.likes++;
                            result = productData.save(product);
                            return [2 /*return*/, res.send(result)];
                    }
                });
            }); });
